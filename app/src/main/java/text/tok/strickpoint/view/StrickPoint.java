...
import text.tok.strickpoint.utils.GeometryUtil;


public class StrickPoint extends View {
    ...
    public StrickPoint(Context context, View mDragView, WindowManager mWm) {
        super(context);
